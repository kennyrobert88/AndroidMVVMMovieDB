package com.example.APITesting.ui.home.popular_movie.Adapter
...
import com.example.APITesting.ui.home.PopularMovie
...
// RecycleView Adapter ->
class PopularMovieLimitPagedListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(
    MovieDiffCallback()
) {
    ...
    class FooterViewHolder(view: View) : RecyclerView.ViewHolder(view){
        fun bind(context: Context){
            ...
            itemView.setOnClickListener{
                val intent = Intent(context, PopularMovie::class.java)
                context.startActivity(intent)
            }
        }
    }
