package com.example.APITesting.ui.home.now_playing_movie.Adapter
...
import com.example.APITesting.ui.home.NowPlayingMovie
import com.example.APITesting.ui.home.TopRatedMovie
import com.example.APITesting.ui.home.popular_movie.Adapter.PopularMovieLimitPagedListAdapter
import com.example.APITesting.ui.single_movie_details.SingleMovie
import kotlinx.android.synthetic.main.item_movie.view.*
import kotlinx.android.synthetic.main.movie_list_item.view.*
import kotlinx.android.synthetic.main.network_state_item.view.*
import kotlinx.android.synthetic.main.next_item.view.*

class NowPlayingMovieLimitPagedListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(
    MovieDiffCallback()
) {
    ...
    class FooterViewHolder(view: View) : RecyclerView.ViewHolder(view){
        fun bind(context: Context){
            ...
            itemView.setOnClickListener{
                val intent = Intent(context, NowPlayingMovie::class.java)
                context.startActivity(intent)
            }
        }
    }
